...
import com.kh.totalJpaSample.dto.CategoryDto;
import com.kh.totalJpaSample.service.CategoryService;
...
public class CategoryController {
    ...
    //카테고리 등록
    @PostMapping("/new")
    public ResponseEntity<Boolean> categoryResgister(@RequestBody CategoryDto categoryDto) {
